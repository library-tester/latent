...
export function renderShop(S){
  setScene(`<div class="pad scroll">
    ...
    <button class="opt" data-a="buy" data-k="remove" ${S.removed || G.gold < 75 ? 'disabled' : ''}>
      <div class="oh">Scrape a plate — 75g</div><div class="od">Remove one card from your deck.</div></button>
